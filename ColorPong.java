...
public class ColorPong extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("State call: "+state_call+" Game name: "+game_name);
	...
	protected void doGameDesc(HttpServletRequest request, HttpServletResponse response) throws ServletException {
		...
		try {
		    ...
		    out.println("<!doctype html>\r\n" + 
		    		...
		    		"                                <a class=\"dropdown-item text-light bg-dark\" href=\"http://www.sephiasky.com/serv/toport?game=ColoredPong&s=main1\">Colorfu</a>\r\n" + 
		    		"                                <a class=\"dropdown-item text-light bg-dark\" href=\"http://www.sephiasky.com/serv/toport?game=ColoredPong&s=main3\">Action</a>\r\n" + 
		    		"                                <a class=\"dropdown-item text-light bg-dark\" href=\"http://www.sephiasky.com/serv/toport?game=ColoredPong&s=main2\">Casual</a>\r\n" + 
		    		"                          </div>\r\n" + 
		    		"              </li>\r\n" + 
		    		"            <li class=\"nav-item\">\r\n" + 
		    		"              <a class=\"nav-link\"\r\n" + 
		    ...
		    out.println("        <div class=\"row\">\r\n" + 
		    		...
		    		"                <a href=\"http://www.sephiasky.com/serv/toport?game=ColoredPong&s=play\" class=\"card-link\">Play</a>\r\n" + 
		    		"              </div>\r\n" + 
		    		"            </div>\r\n" + 
		    		"        </div>\r\n" + 
		    		"    </div>\r\n" + 
