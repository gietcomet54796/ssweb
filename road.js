class Road extends Phaser.GameObjects.Container {
    constructor(config) {
       ...
       //this.back.scaleY=this.back.scaleX;
        Align.scaleToGameW(this.back, .5);  // you'll get an error if you forgot to add align script tag
    ...
    addObject()
    {
      ...
      var objs=[{key:'pcar1',speed:10, scale:10},{key:'pcar2',speed:10, scale:10},{key:'cone',speed:20, scale:5},{key:'barrier',speed:20, scale:5}]
    ...
    moveObject()
    {
      ...
      if(Collision.checkCollide(this.car,this.object)==true)
      {
        ...
        this.scene.time.addEvent({ delay: 200, callback: this.goGameOver, callbackScope: this.scene, loop: false });
      }
      else
      {
          this.car.alpha=1;
    ...
    makeLines()
    {
      ...
      for(var i=0; i<20; i++)
      {
        ...
        line.oy=line.y; //adding the reset line
